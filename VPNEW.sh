...
get_ikev2_script() {
  ...
  ikev2_url="https://raw.githubusercontent.com/siemenstutorials/L2tp/master/extras/ikev2setup.sh"
  (
    set -x
...
get_libreswan() {
    ...
    bigecho "Libreswan libreswan-4.5.tar.gz is already installed, skipping..."
  fi
}
